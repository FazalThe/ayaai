...
import { Sheet, SheetContent } from "@/components/ui/sheet" // Adjusted path
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/components/ui/tooltip" // Adjusted path
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Check if document is defined (for SSR safety, though likely client-side)
